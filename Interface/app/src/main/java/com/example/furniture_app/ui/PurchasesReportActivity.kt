...
class PurchasesReportActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recycler = findViewById<RecyclerView>(R.id.recyclerReport)
        title.text = "Purchases Report"
        recycler.layoutManager = LinearLayoutManager(this)

        RetrofitClient.apiService.getPurchasesReport().enqueue(object :
